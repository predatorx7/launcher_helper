...
// import 'package:launcher_helper/src/palette_generator.dart';
...
//     if (background != null) {
//       backgroundLayer = FutureBuilder(
//         future: PaletteGenerator.fromUint8List(background),
//         builder: (context, AsyncSnapshot<PaletteGenerator> asyncSnapshot) {
//           print("Determining background");
//           if (asyncSnapshot.hasData) {
//             var bgColors = asyncSnapshot.data?.colors;
//             if ((bgColors?.length ?? 0) > 1) {
//               return Image.memory(background);
//             } else {
...
//       );
//     }
//     if (background != null) iconLayerStack.insert(0, backgroundLayer);
//     Widget child = Stack(
